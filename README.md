...
* [Module hw03 ДЗ "Демонстрация SOLID принципов"](#Module-hw03-solid)
...
# Module hw03 ДЗ "Демонстрация SOLID принципов" <a name="Module-hw03-solid"></a>
> Цель:  
...
## Результат
![](hw03/imgs/execution-result.png)

## Реализация принципов
### SRP – принцип единой ответственности
#### Класс AppInitFromFile
Ответственность - только загрузка настроек игры определенным способом.
#### Класс GuessNumberGameFactory 
...
#### Классы GuessNumberGameFactory и LiskovGuessNumberGeneratorStrategy
...
Каждый класс программы реализует только те интерфейсы, функциональность которых действительно должны быть реализована в данном классе.  

### DIP - Принцип инверсии зависимостей
#### Класс GuessNumberGameStrategy
Передача в класс GuessNumberGameStrategy потоков ввода/вывода и конкретной реализации генерации "загаданного" числа через конфигурацию.  
